...
import 'package:agent_007/presentation/pages/dashboard/components/home_widget2.dart';
import 'package:agent_007/presentation/pages/dashboard/components/home_widget3.dart';
                    ...
                    body: Stack(
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              Expanded(flex: 1, child: HomeWidget(name: cubit.model.name)),
                              ...
                              Expanded(
                                  ...
                                  flex: 1,
                                  child: HomeWidget3(
                                    coast: Helper.toProcessCost(cubit.model.payed),
