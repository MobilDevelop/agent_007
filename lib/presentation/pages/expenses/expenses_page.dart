            ...
            child: BlocBuilder<ExpensesCubit, ExpensesState>(
                builder: (_, state) => Scaffold(
                          ...
                          SizedBox(
                            ...
                            child: NotificationListener<ScrollNotification>(
                              onNotification: (notification){
                                if(notification.metrics.pixels==notification.metrics.maxScrollExtent && !cubit.loding){
                                  cubit.init();
                                  return false;
                                }
                                return true;
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) => ExpensesWidget1(
                                        ontap:()=>  cubit.payment(cubit.items[index].id),
                                       item: cubit.items[index], controller: cubit.paymentController,
                                      )),
                            ),
                          ),
                          Visibility(
                      ...
                      floatingActionButton: FloatingActionButton(
                        onPressed: () {
                          context.push(Routes.addexpenses.path).then((value) => cubit.init());
                        },
                        backgroundColor: AppTheme.colors.primary,
