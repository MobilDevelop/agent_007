...
class ExpensesWidget1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        controller.text = (double.parse(item.amount)-double.parse(item.payed)).toString();
        item.paybtn? AwesomeDialog(
                context: context,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(tr('expenses.narxi'), style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: Colors.grey
                      )),
                  ...
                  Column(
                    ...
                    children: [
                      Text(tr('expenses.tolangan'),style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: Colors.grey)),
             ...
             Row(
              ...
              children: [
                 Row(
                   children: [
                     Text(tr('expenses.status'),style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: Colors.grey)),
                     Container(
             ...
             Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(tr('expenses.obyekt'), style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: Colors.grey
                      )),
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text(tr('expenses.harajat'),style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: Colors.grey)),
             ...
             Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: [
                 Text(tr('expenses.izoh'),style: AppTheme.data.textTheme.bodyLarge!.copyWith(color: Colors.grey)),
